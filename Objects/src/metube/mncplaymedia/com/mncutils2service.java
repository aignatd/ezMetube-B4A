...
public class mncutils2service extends android.app.Service {
	...
	public void onCreate() {
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "metube.mncplaymedia.com", "metube.mncplaymedia.com.mncutils2service");
            try {
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "metube.mncplaymedia.com.mncutils2service", processBA, _service);
		}
...
public metube.mncplaymedia.com.fungsi _fungsi = null;
  public Object[] GetGlobals() {
		return new Object[] {"Fungsi",Debug.moduleToString(metube.mncplaymedia.com.fungsi.class),"hc",_hc,"Login",Debug.moduleToString(metube.mncplaymedia.com.login.class),"Main",Debug.moduleToString(metube.mncplaymedia.com.main.class),"Register",Debug.moduleToString(metube.mncplaymedia.com.register.class),"Service",mostCurrent._service,"taskCounter",_taskcounter,"TaskIdToJob",_taskidtojob,"TempFolder",_tempfolder,"tmpMap",_tmpmap,"Utama",Debug.moduleToString(metube.mncplaymedia.com.utama.class)};
}
public static String  _clearcookies() throws Exception{
try {
		Debug.PushSubsStack("ClearCookies (mncutils2service) ","mncutils2service",5,processBA,mostCurrent,126);
...
try {
		Debug.PushSubsStack("CompleteJob (mncutils2service) ","mncutils2service",5,processBA,mostCurrent,110);
metube.mncplaymedia.com.mnchttpjob _job = null;
...
_job = new metube.mncplaymedia.com.mnchttpjob();Debug.locals.put("job", _job);
 BA.debugLineNum = 113;BA.debugLine="Try";
Debug.ShouldStop(65536);
try { BA.debugLineNum = 114;BA.debugLine="job = TaskIdToJob.Get(TaskId)";
Debug.ShouldStop(131072);
_job = (metube.mncplaymedia.com.mnchttpjob)(_taskidtojob.Get((Object)(_taskid)));Debug.locals.put("job", _job);
...
try {
		Debug.PushSubsStack("hc_ResponseError (mncutils2service) ","mncutils2service",5,processBA,mostCurrent,73);
int _i = 0;
int _k = 0;
String[] _z = null;
String[] _z1 = null;
...
try {
		Debug.PushSubsStack("hc_ResponseSuccess (mncutils2service) ","mncutils2service",5,processBA,mostCurrent,46);
String[] _z = null;
String[] _z1 = null;
anywheresoftware.b4a.objects.collections.List _lstcookie = null;
Debug.locals.put("Response", _response);
...
try {
		Debug.PushSubsStack("Response_StreamFinish (mncutils2service) ","mncutils2service",5,processBA,mostCurrent,65);
Debug.locals.put("Success", _success);
Debug.locals.put("TaskId", _taskid);
...
try {
		Debug.PushSubsStack("Service_Create (mncutils2service) ","mncutils2service",5,processBA,mostCurrent,15);
...
try {
		Debug.PushSubsStack("Service_Destroy (mncutils2service) ","mncutils2service",5,processBA,mostCurrent,27);
...
try {
		Debug.PushSubsStack("Service_Start (mncutils2service) ","mncutils2service",5,processBA,mostCurrent,23);
...
public static int  _submitjob(metube.mncplaymedia.com.mnchttpjob _job) throws Exception{
try {
		Debug.PushSubsStack("SubmitJob (mncutils2service) ","mncutils2service",5,processBA,mostCurrent,31);
