...
public class mnchttpjob extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "metube.mncplaymedia.com.mnchttpjob");
            if (htSubs == null) {
                ba.loadHtSubs(this.getClass());
                htSubs = ba.htSubs;
            }
            if (BA.isShellModeRuntimeCheck(ba)) {
			    ba.raiseEvent2(null, true, "CREATE", true, "metube.mncplaymedia.com.mnchttpjob",
                    ba);
                return;
		    }
        }
...
public metube.mncplaymedia.com.mncutils2service _mncutils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"ErrorMessage",_errormessage,"Fungsi",Debug.moduleToString(metube.mncplaymedia.com.fungsi.class),"JobName",_jobname,"Login",Debug.moduleToString(metube.mncplaymedia.com.login.class),"Main",Debug.moduleToString(metube.mncplaymedia.com.main.class),"MNCUtils2Service",Debug.moduleToString(metube.mncplaymedia.com.mncutils2service.class),"Password",_password,"ProMap",_promap,"Register",Debug.moduleToString(metube.mncplaymedia.com.register.class),"req",_req,"ResMap",_resmap,"Success",_success,"Tag",_tag,"target",_target,"taskId",_taskid,"Username",_username,"Utama",Debug.moduleToString(metube.mncplaymedia.com.utama.class)};
}
...
try {
		Debug.PushSubsStack("Complete (mnchttpjob) ","mnchttpjob",6,ba,this,88);
...
try {
		Debug.PushSubsStack("Download (mnchttpjob) ","mnchttpjob",6,ba,this,58);
...
try {
		Debug.PushSubsStack("Download2 (mnchttpjob) ","mnchttpjob",6,ba,this,67);
...
try {
		Debug.PushSubsStack("GetBitmap (mnchttpjob) ","mnchttpjob",6,ba,this,136);
...
try {
		Debug.PushSubsStack("GetBitmapSampled (mnchttpjob) ","mnchttpjob",6,ba,this,149);
anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _b = null;
...
try {
		Debug.PushSubsStack("GetInputStream (mnchttpjob) ","mnchttpjob",6,ba,this,143);
...
try {
		Debug.PushSubsStack("GetRequest (mnchttpjob) ","mnchttpjob",6,ba,this,83);
...
try {
		Debug.PushSubsStack("GetString (mnchttpjob) ","mnchttpjob",6,ba,this,99);
...
try {
		Debug.PushSubsStack("GetString2 (mnchttpjob) ","mnchttpjob",6,ba,this,104);
...
try {
		Debug.PushSubsStack("GetString3 (mnchttpjob) ","mnchttpjob",6,ba,this,119);
anywheresoftware.b4a.objects.streams.File.TextReaderWrapper _tr = null;
String _res = "";
...
innerInitialize(_ba);
try {
		Debug.PushSubsStack("Initialize (mnchttpjob) ","mnchttpjob",6,ba,this,18);
...
try {
		Debug.PushSubsStack("PostBytes (mnchttpjob) ","mnchttpjob",6,ba,this,28);
Debug.locals.put("Link", _link);
...
try {
		Debug.PushSubsStack("PostFile (mnchttpjob) ","mnchttpjob",6,ba,this,35);
int _length = 0;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
try {
		Debug.PushSubsStack("PostString (mnchttpjob) ","mnchttpjob",6,ba,this,23);
Debug.locals.put("Link", _link);
...
try {
		Debug.PushSubsStack("Release (mnchttpjob) ","mnchttpjob",6,ba,this,94);
